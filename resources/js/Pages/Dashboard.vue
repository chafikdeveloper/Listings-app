...
const deleteListing = (id) => {
  if (confirm("Do you want to delete this testing ?")) {
...
<template>
  ...
  <div v-if="listings">
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex items-center gap-4 text-xs">
            ...
            <p>Pending <i class="fa-solid fa-circle-xmark text-red-500"></i></p>
          </div>
        </div>
            ...
            <tr v-for="listing in listings.data" :key="listing.id"
              ...
              <td class="w-3/4 p-3 text-left">
                <div class="flex items-center gap-2">
                  ...
                  <h4 class="font-bold">{{ listing.title }} <i
    ...
    <!-- No listings to show -->
    <div v-else>
      You have no listings, Let's create one first!
    </div>
  </div>
  ...
  <div v-else>
    Due to violation of our terms your account has been suspended, please contact us at <span
      class="text-link">admin@listings.com</span>
  </div>
</template>